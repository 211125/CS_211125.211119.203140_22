...
router.get("/all_son", async function (req, res) {
  getSon
...
router.post("/create_son", async function (req, res) {
  getSon
    .create({
      name: req.query.name,
...
router.put("/update_son", async function (req, res) {
  let id = req.query.id;
...
router.delete("/destroy_son", async function (req, res) {
  let id = req.query.id;
